...
public: // Function declarations
  ...
  int get_N(); //Added for exercise 4.2
  double get_rho(); //Added for exercise 4.2
  void print_positions();
  double get_velocity(int i, int j);
  double get_position(int i, int j);
  void finale_state();
